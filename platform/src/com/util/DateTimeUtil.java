...
public class DateTimeUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(DateTimeUtil.formatDateTime(DateTimeUtil.dateOperation(new Date(), 0, 0, 10, 0), "yyyy-MM-dd HH:mm:ss"));
		Date updateTime = DateTimeUtil.getDateTime("2017-04-16 00:14:51");
		//计算时间差
		System.out.println(DateTimeUtil.getTimeInterval(DateTimeUtil.parseDate("2016-09-03 10:10","yyyy-MM-dd HH:mm").getTime(), (new Date()).getTime()));
		Date date = new Date();
	    DateTimeUtil.parseDate("2016-09-05 16:10","yyyy-MM-dd HH:mm");
