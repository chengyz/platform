...
public class UserInfo implements Serializable{
	...
	@TableField(fieldSize=100,comment="归属单位统一编号,UUID自动生成")
	private String unitName;
	@TableField(fieldSize=100,comment="用户姓名")
	private String userName;
	@TableField(fieldSize=2,isNotNull=true,comment="用户类型（0平台超级管理员， 1平台一般管理员， 2平台普通用户，3企业超级管理员， 4企业一般管理员， 5企业普通用户）")
	...
	@TableField(fieldSize=1,comment="用户性别（1男 2女 3其他：未知）")
	private String userSex;
	@TableField(fieldSize=2,comment="状态：1正常启用,2注销, 3停用")
