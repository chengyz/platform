...
public class MenuInfoServiceImpl implements IMenuInfoService{
	...
	public boolean saveOrUpMenu(String sourceId,boolean closeConn,MenuInfo mi) {
		...
		if(!"-1".equals(mi.getMenuParentCode())){
			...
			this.upMenuLowerNodeState( sourceId, closeConn,mi.getUnitUUID(),mi.getMenuParentCode(),"1");
		}
		if(mi.getId()==null){
	...
	public MenuInfo findMenuByID(String sourceId,boolean closeConn,String unitUUID, String id) {
		if(unitUUID==null || "".equals(unitUUID) || "null".equals(unitUUID) || id==null || "".equals(id) || "null".equals(id)){
			return null;
		}
		StringBuilder sql = new StringBuilder();
		List<Object> params = new ArrayList<Object>();
	...
	public String getMenuCodeNext(String sourceId,boolean closeConn,String menuParentCode) {
		if (menuParentCode == null || "".equals(menuParentCode)) {
			return null;
		}
		StringBuilder sql = new StringBuilder();
		List<Object> params = new ArrayList<Object>();
	 ...
	 * @return
	 */
	private boolean upMenuLowerNodeState(String sourceId,boolean closeConn,String unitUUID,String menuCode,String menuHaveLowerNode){
	...
	@Override
	public MenuInfo findMenuByMenuMark(String sourceId, boolean closeConn,
			String menuMark) {
		if(menuMark==null || "".equals(menuMark) || "null".equals(menuMark)){
			return null;
		}
		StringBuilder sql = new StringBuilder();
		List<Object> params = new ArrayList<Object>();
		sql.append("select * from menu_info where menuPermission = ?");
		params.add(menuMark);
