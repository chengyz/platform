...
<body>
	...
	<br>
	<form id="rolePermissionForm" class="form-inline">
	...
	<div class="hidden">
		<script type="text/javascript">
			$(function (){
				setMultiSelectVal("<%=roleUUID%>","<%=unitUUID%>");
			});
			
		//设置multiselect的值
		function setMultiSelectVal(roleUUID,unitUUID){
		    //查所有菜单信息
	    	var url = '<%=path%>/system/menuRole/findMenuToAddPermission?roleUUID='+roleUUID+'&unitUUID='+unitUUID;
	    	var htmlOption = "";
		...
		function getFromSerialize() {
			return $('#rolePermissionForm').serialize();
		}
		//修改数据时
		function initData() {
