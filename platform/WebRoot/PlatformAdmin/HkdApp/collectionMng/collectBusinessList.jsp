	...
	<table id="collectTable" class="table table-bordered table-hover">
		<thead>
			<tr>
			    ...
			    <th field="businessName" limitTxtLen="15">商家简称</th>
			    <th field="businessFullName" limitTxtLen="20">商家全称</th>
			    <th field="businessArea" limitTxtLen="20">商家所在区域</th>
			    <th field="businessAddr" limitTxtLen="20">商家详细地址</th>
			    <th field="businessTel" limitTxtLen="15">商家电话</th>
...
<script type="text/javascript">
	$(function(){
		var url = 'hkdapp/collectBusiness/findBusinessList';
	...
	function openCollectWin(type, id) {
		...
		var url = 'PlatformAdmin/HkdApp/collectionMng/collectBusinessDetail.jsp';
		var area = ['50%', '55%'];
		var row = null;
		if(id){
			row = datas[id];
