...
<body>
	...
	<br>
	<form id="unitPermissionForm" class="form-inline">
	...
	<div class="hidden">
		<script type="text/javascript">
			$(function (){
				setMultiSelectVal("<%=unitUUID%>");
			});
			
		//设置multiselect的值
		function setMultiSelectVal(unitUUID){
		    //查所有菜单信息
	    	var url = "<%=path%>/system/menuUnit/findMenuToAddPermission?unitUUID="+unitUUID;
	    	var htmlOption = "";
		...
		function getFromSerialize() {
			return $('#unitPermissionForm').serialize();
		}
		//修改数据时
		function initData() {
