	...
	$(".fixed").each(function() {
		...
		$(window).bind("scroll", function() {
			...
			if (style == "fixed-top" && thistop < 0) {
				...
				$("#imgId").removeClass("fexedLevel2LogoImg");
				$("#imgId").addClass("fexedLevel2LogoImgAScrooll");
			} else {
				$("#imgId").removeClass("fexedLevel2LogoImgAScrooll");
				$("#imgId").addClass("fexedLevel2LogoImg");
