...
<body>
	...
	<br>
	<form id="userPermissionForm" class="form-inline">
	...
	<div class="hidden">
		<script type="text/javascript">
			$(function (){
				setMultiSelectVal("<%=userUUID%>","<%=unitUUID%>");
			});
			
		//设置multiselect的值
		function setMultiSelectVal(userUUID,unitUUID){
		    //查所有菜单信息
	    	var url = "<%=path%>/system/menuUser/findMenuToAddPermission?userUUID="+userUUID+"&unitUUID="+unitUUID;
	    	var htmlOption = "";
		...
		function getFromSerialize() {
			return $('#userPermissionForm').serialize();
		}
		//修改数据时
		function initData() {
