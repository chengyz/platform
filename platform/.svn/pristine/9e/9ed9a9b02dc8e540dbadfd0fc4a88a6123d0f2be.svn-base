...
(function () {
	//最关键的配置
//	window.UEDITOR_HOME_URL = "/cmccDemo/ueditor/";
    /**
...
//        ,imagePath:URL + "jsp/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ,imageUrl:URL+"jsp/imageUp.jsp?folder_url="+folder_url             //图片上传提交地址
       ...
       // ,scrawlPath:URL+"jsp/"                            //图片修正地址，同imagePath
        ...
        ,catcherPath:"/tdc/ueditor/upload"
        ...
        ,imageManagerPath:"/tdc/ueditor/upload"
        //屏幕截图配置区
        ...
        //获取视频数据的地址
        ,getMovieUrl:"jsp/getMovie.jsp"                   //视频数据获取地址
...
//        ]
        ...
        ['fullscreen', 'source', '|', 'undo', 'redo', '|',
         ...
         'justifyleft', 'justifycenter', 'justifyright', 'justifyjustify', '|','touppercase','tolowercase','|',
         'link', 'unlink', 'anchor', '|', 'imagenone', 'imageleft', 'imageright','imagecenter', '|',
         'insertimage', 'insertvideo','attachment','highlightcode','pagebreak','template','|',
