...
<body>
	...
	<div class="hidden">
		<script type="text/javascript">
			$(function (){
				setMultiSelectVal("<%=unitUUID%>","<%=userUUID%>");
			});
			
		//设置multiselect的值
		function setMultiSelectVal(unitUUID,userUUID){
		    //查所有菜单信息
	    	var url = "<%=path%>/system/roleUser/findRoleToAssignRole?unitUUID="+unitUUID+"&userUUID="+userUUID;
	    	var htmlOption = "";
